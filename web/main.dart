...
class GameController {
  ...
  loadLevel(var level) {
    ...
    var board = new Board(currentLevel["level"], currentLevel["boardSize"],
        currentLevel["colors"], currentLevel["board"]);
...
class BoardView {
  ...
  init() {
    ...
    this.width =
        double.parse(rootElem.style.width.replaceAll("px", "")) / boardModel.x;
    this.height = width;
