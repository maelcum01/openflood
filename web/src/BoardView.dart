part of main;
/* The View Class:
    Initializes and renders the DOM/HTML elements
...
class BoardView
{
  ...
  init()
  {
    ...
    for(var color in this.colors)     // create button elements of each color from json list of strings, within the button bar div element
    {
